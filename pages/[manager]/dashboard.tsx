        ...
        <main className='flex-1'>
            ...
            <div className="px-[33px] xl:px-[42px] pt-[29px] xl:pt-[47px] pb-[54px]">
                ...
                <div className="grid gap-2.5 md:grid-cols-2 xl:grid-cols-4 mb-[51px] lg:mb-[35.08px]">
                    ...
                    <StatCard color='blue' title={blocks.products}>
                        <div className="flex items-end justify-between">
                            <div className='pb-[7px] md:pb-[5px]'>
                                <span className="font-bold text-3xl md:text-lg">{data && data.blocks && data.blocks.products}</span>
                            </div>
                    ...
                    <StatCard color='sky' title={blocks.frequencies}>
                        <div className="flex items-end justify-between">
                            <div className='pb-[7px] md:pb-[5px]'>
                                <span className="font-bold text-3xl md:text-lg">{data && data.blocks && data.blocks.frequencies}</span>
                            </div>
                    ...
                    <StatCard color='yellow' title={blocks.ranges}>
                        <div className="flex items-end justify-between">
                            <div className='pb-[7px] md:pb-[5px]'>
                                <span className="font-bold text-3xl md:text-lg">{data && data.blocks && data.blocks.ranges}</span>
                            </div>
