import { AdjustmentsHorizontalIcon, ChatBubbleOvalLeftEllipsisIcon, WrenchIcon, CogIcon, ComputerDesktopIcon, PhotoIcon, TagIcon, UserGroupIcon, UserPlusIcon, Cog8ToothIcon, ShoppingBagIcon, Square3Stack3DIcon, SignalIcon } from "@heroicons/react/24/outline";
                            ...
                            <div className="space-y-3">
                                ...
                                {data && 'role' in data && data.role.features.filter(({ prefix }) => resources.includes(prefix)).map(({ prefix }) => {
                                    ...
                                    return <NavItem key={JSON.stringify(cms.sidebar.menu[resource as ResourceType])} icon={{
                                        ...
                                        roles: TagIcon,
                                        features: CogIcon,
                                        ranges: Square3Stack3DIcon,
                                        frequencies: SignalIcon,
